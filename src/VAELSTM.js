        ...
        return (
            <div id='outer_container'>
                <div id='container'>
                    ...
                    <div style={{textAlign: 'center'}}><Figure><Figure.Image class='loss' src={vae2}/><Figure.Caption>Figure 2. Configuration A test loss</Figure.Caption></Figure></div>
                    <div style={{textAlign: 'center'}}><Figure><Figure.Image class='loss' src={vae3}/><Figure.Caption>Figure 3. Configuration B test loss</Figure.Caption></Figure></div>
                    <div style={{textAlign: 'center'}}><Figure><Figure.Image class='loss' src={vae4}/><Figure.Caption>Figure 4. Configuration B Reconstruction and KL test loss</Figure.Caption></Figure></div>
                    ...
                    <div style={{textAlign: 'center'}}><Figure><Figure.Image  src={vae5}/><Figure.Caption>Figure 5. Next 50 calculated positions for random agent</Figure.Caption></Figure></div>
                    ...
                    <div style={{textAlign: 'center'}}>
                        ...
                        <Figure.Caption>Figure 6. Randomly sampled trajectories</Figure.Caption>
                    </div>
                </div>
            </div>
        )
